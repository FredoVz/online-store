    ...
    <MemberLayout>
      ...
      <div className={styles.profile__main}>
        <div className={styles.profile__main__avatar}>
          {profile.image ? <Image className={styles.profile__main__avatar__image} src={profile.image} alt="profile" width={200} height={200} /> : <div className={styles.profile__main__avatar__image}>{profile?.fullname?.charAt(0)}</div>}
          ...
          <form onSubmit={handleChangeProfilePicture}>
            ...
            />
            <Button className={styles.profile__main__avatar__button} type="submit">
        ...
        <div className={styles.profile__main__detail}>
          <form action="">
            ...
            <Input label="Email" type="email" name="email" defaultValue={profile.email} />
            <Input label="Phone" type="number" name="phone" defaultValue={profile.phone} />
            {/* <Input label="Password" type="password" name="password" defaultValue={profile.password} /> */}
